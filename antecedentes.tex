...
\subsection{Ecuación de Friis} \label{friis}
...
Para que un obstaculo no interfiera significativamente en la transmision de la señal en el aire, se debe mantener a lo menos la primera zona de Fresnel (n=1) libre.
...
El movimiento de un electrón en un átomo de hidrógeno neutro genera un campo magnético que se acopla con los espines del protón y el electrón. \quotes{Este acople da cuenta de la radiación a 1420 MHz que viene de la transición entre dos niveles energéticos del nivel fundamental del Hidrógeno} \cite{Restrepo2023}.\\
