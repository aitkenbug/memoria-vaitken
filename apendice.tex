...
\section*{cpt\_rtl\_adquisition.py}
...
\includehfpdf[pages=-]{draws/soporte_patas}\label{fig:soporte_patas}
\includehfpdf[pages=-]{draws/soporte_feed}\label{fig:soporte_feed}
\includehfpdf[pages=-]{draws/paleta}\label{fig:paleta}
\includehfpdf[pages=-]{draws/paleta_feed}\label{fig:paleta_feed}
\includehfpdf[pages=-]{draws/soporte_patch} \label{fig:soporte_patch}